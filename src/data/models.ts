...
export const DEFAULT_MODELS: AIModel[] = [
  ...
  },
  {
    ...
    description: "Ultra-fast multimodal flagship with zero quota limits, 3-key auto-failover, and native image/document OCR.",
  ...
  },
  {
    ...
    description: "Deep analytical reasoning model designed for high-level STEM, multi-stage planning, and massive multi-document synthesis.",
...
export const STARTER_PROMPTS: StarterPrompt[] = [
  ...
  {
    id: "4",
    title: "Professional Resume & CV Builder",
    subtitle: "Draft modern ATS-compliant resume with 1-click PDF download",
    prompt: "Create an ATS-friendly, modern professional software engineer resume for Shawez Khan with 3 years of full-stack AI development experience, key skills, and impact-driven bullet points.",
    iconName: "FileText",
